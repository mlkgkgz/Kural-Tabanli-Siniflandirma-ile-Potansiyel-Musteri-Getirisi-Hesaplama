...
df = pd.read_csv("C:/Users/.../persona.csv")
df.head()
df.shape
df.info()
df.describe().T
...
agg_df["N_AGE"] = pd.cut(agg_df["AGE"], [0,18,23,30,40,70], labels=['0_18', '19_23', '24_30', '31_40', '41_70'])
agg_df.info()
...
# Birçok aynı segment olacak. örn. USA_ANDROID_MALE_0_18 segmentinden birçok sayıda olabilir.
